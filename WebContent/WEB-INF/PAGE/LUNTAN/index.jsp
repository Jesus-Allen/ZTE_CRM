...
<br/>
	<div class="main w">
		...
		<div class="body1 w">
			<div class="title">
				<strong><span class="one">论坛</span></strong> <strong><span class="two">主题数</span></strong> <strong><span
					class="three">最后发表时间</span></strong>
			</div>
			<div class="list">
				<%
				...
				%>
				<div class="board w">
					<span><strong><%=board.getBoardTitle()%></strong></span>
				</div>

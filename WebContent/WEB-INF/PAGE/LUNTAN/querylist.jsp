...
<%  request.setCharacterEncoding("utf-8");
	...
	List listTopic = topicDao.findListTopic(p, boardId,query);
...
<br/>
	<div class="main w">
		...
		<div class="menu w">
			<span><a href="luntanindex.html">论坛首页--</a><a href="luntanlist.html?page=1&boardId=<%=boardId%>"><%=board.getBoardTitle()%></a></span>

		</div>

		<div class="page w">
			<div class="fy">
				<a href="luntanquerylist.html?page=<%=up%>&boardId=<%=boardId%>">上一页 </a>|<a
					href="luntanquerylist.html?page=<%=down%>&boardId=<%=boardId%>"> 下一页</a>
			</div>

			<div class="post">
			   
				<a href="luntanlist.html?page=1&boardId=<%=boardId%>"><button>返回</button></a>
			</div>
		...
		<div class="body1 w">
			<div class="title">
				<span style="margin-left: 280px">文章</span> <span
					style="margin-left: 380px">作者</span> <span

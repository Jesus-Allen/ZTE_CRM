            ...
            <div class="panel-group" id="accordion" style="margin-top:10px">
                    ...
                    <form class="form-horizontal" role="form" action="registaction.html" method="post" id="user">
					   ...
					   <div class="form-group">
					       <div class="col-md-6 col-md-offset-4">
						      <input type="checkbox" id="check" name="check">&nbsp;&nbsp;我已阅读并同意中兴公司
						      <a href="treaty.html" target="_blank">用户注册协议</a>
					       </div>
                       </div>
              ...
              <div class="panel panel-default">
                ...
                <div id="b" class="panel-collapse collapse in" style="height: 0px;">
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" action="registaction.html" method="post" id="user2">
                      <input type="hidden" name="userId" id="hid" value="2">
                       <div class="form-group">
              ...
              <div class="panel panel-default">
                ...
                <div id="c" class="panel-collapse collapse in" style="height: 0px;">
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" action="registaction.html" method="post" id="user3">
                      <input type="hidden" name="userId" id="hid" value="3">
                       <div class="form-group">
                          <label for="userName" class="col-md-2 control-label"><font color="red">*</font>用户账号</label>
                          <div class="col-md-8">
                             <input type="text" class="form-control" name="userName" placeholder="用户帐号由3-20位的英文字母、数字或下划线组成，必须以字母开头">
			  ...
			  <div class="panel panel-default">
                ...
                <div id="d" class="panel-collapse collapse in" style="height: 0px;">
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" action="registaction.html" method="post" id="user4">
                          <input type="hidden" name="userId" id="hid" value="4">                       <div class="form-group">
                          <label for="userName" class="col-md-2 control-label"><font color="red">*</font>用户账号</label>
                          <div class="col-md-8">
                             <input type="text" class="form-control" name="userName" placeholder="用户帐号由3-20位的英文字母、数字或下划线组成，必须以字母开头">
                          </div>
                       ...
                       <div class="form-group">
                          <label for="userLinkMan" class="col-md-2 control-label"><font color="red">*</font>姓名</label>
                          <div class="col-md-8">
                             <input type="text" class="form-control" name="name" placeholder="完善您个人基本信息有助于提高我们的服务质量">
                          </div>
                       </div>
			  ...
			  <div class="panel panel-default">
                ...
                <div id="e" class="panel-collapse collapse in" style="height: 0px;">
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" action="registaction.html" method="post" id="user5">
                       <input type="hidden" name="userId" id="hid" value="5">
                       <div class="form-group">
                          <label for="userName" class="col-md-2 control-label"><font color="red">*</font>用户账号</label>
                          <div class="col-md-8">
                             <input type="text" class="form-control" name="userName" placeholder="用户帐号由3-20位的英文字母、数字或下划线组成，必须以字母开头">

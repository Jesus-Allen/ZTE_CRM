 ...
 <form class="form-horizontal" role="form" action="admin_user_add_action.html" method="post" id="user3">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="userName"  placeholder="用户帐号由3-20位的英文字母、数字或下划线组成，必须以字母开头"  readonly="true" value="${userInfo.userName}"/>
                          </div>
                       </div>
                       <div class="form-group">
                          ...
                          <div  class="col-md-3">
                             <!-- 取数据 --> 
                             <c:if test="${userInfo.userSex==null || empty userInfo.userSex}"> 
                                <div  class="col-md-3">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-md-8">
                             <input type="password" class="form-control" name="userPwd" placeholder="密码请保持在6-40位字符长度 " value="${userInfo.userPwd }">
                          </div>
                       </div>
                       <div class="form-group">
                          <label for="affirmPwd" class="col-md-2 control-label"><font color="red">*</font>重复密码</label>
                          <div class="col-md-8">
                             <input type="password" class="form-control" name="affirmPwd" placeholder="再次输入你的密码，两次密码需一致" value="${userInfo.userPwd }">
                          </div>
                       </div>
					   <div class="form-group">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-md-8">
                             <input type="text" class="form-control" name="name" placeholder="真实姓名" value="${userInfo.name }">
                          </div>
                       </div>
                       <div class="form-group">
                          <label for="userEmail" class="col-md-2 control-label"><font color="red">*</font>邮箱</label>
                          <div class="col-md-8">
                             <input type="email" class="form-control" name="userEmail"  readonly="true" value="${userInfo.userEmail}"/>
                          </div>
                       </div>
                       <div class="form-group">
                          <label for="userTel" class="col-md-2 control-label"><font color="red">*</font>联系电话</label>
                          <div class="col-md-8">
                             <input type="tel" class="form-control" name="userTel" readonly="true" value="${userInfo.userTel}">
                          </div>
                       </div>
                       <div class="form-group">
                          <label for="userUnit" class="col-md-2 control-label"><font color="red">*</font>客户单位</label>
                          <div class="col-md-8">
                             <input type="text" class="form-control" name="userUnit" value="${userInfo.userUnit}" placeholder="请填写单位全称">
                          </div>
                       </div>
					   <div class="form-group">
                          <label for="userUrl" class="col-md-2 control-label">公司网址</label>
                          <div class="col-md-8">
                             <input type="url" class="form-control" name="userUrl" value="${userInfo.userUrl}" placeholder="http://">
                          </div>
                       </div>
                       <div class="form-group">
...
<script src="${pageContext.request.contextPath}/admin-js/userInfoUpdate.js"></script>
</body>
</html>
<script>
    $(function () {       

...
public class TopicDaoImpl extends BaseDao implements TopicDao {
	...
	public int addTopic(Topic topic) {
        ...
        System.out.println("addtopic========================"+topic+topic.getTitle());
	...
	@Override
	public List findListTopic(int page, int boardId,String query) {
		...
		List list = new ArrayList(); // 用来保存主题对象的列表
		String sql = "select * from topic where boardId=" + boardId
				+" and title like '%"+query+ "%' order by publishTime desc limit "+rowBegin+",20";
		try {
			 System.out.println("2"+"page"+page+",boardId"+boardId);
			conn=this.getConn();
			pstmt=conn.prepareStatement(sql);
